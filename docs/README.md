...
Everything about how VibeCraft is built and run, one topic per file. Start with the architecture if you are new here.
...
- [Migration Map](migration/README.md) - The move from the monolith to microservices
