...
| Change how a generated file gets persisted | `workspace-service` `service/impl/ProjectFileServiceImpl.java` (and `InternalWorkspaceController` in front of it); `intelligence-service` `AiGenerationServiceImpl.finalizeChats` |
