...
- Composite primary keys (`ProjectMember`, `ChatSession`) modeled via `@EmbeddedId` + `@MapsId`, with a small dedicated `Serializable` ID class (`ProjectMemberId`, `ChatSessionId`) per entity.
