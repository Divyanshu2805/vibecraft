...
| [Kubernetes](kubernetes.md) | fabric8 client, RBAC, pod security, service links, Kustomize, MinIO, Secrets, CronJobs, ConfigMaps |
| [CI and tooling](ci-and-tooling.md) | GitHub Actions, Tailscale, GHCR, Windows shells, operator scripts |
