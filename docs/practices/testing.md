...
- Frontend: Vitest + Testing Library. Most of the 270 existing tests target `lib/` (framework-free logic) directly rather than rendered components — prefer that shape for new logic too, since it doesn't need jsdom quirks worked around.
