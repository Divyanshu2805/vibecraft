...
erDiagram
    ...
    PROJECT {
        ...
        bigint currentFileRevisionId "nullable, plain id - see File revisions"
        timestamp createdAt
        timestamp updatedAt
        timestamp deletedAt
    }
    ...
    PROJECT_FILE {
        ...
        bigint size
        string type
        string contentHash "nullable - null until the file is first revised"
    ...
    PREVIEW {
        ...
        string bootstrapOwner "nullable"
        timestamp bootstrapHeartbeatAt "nullable"
        timestamp createdAt
    }
