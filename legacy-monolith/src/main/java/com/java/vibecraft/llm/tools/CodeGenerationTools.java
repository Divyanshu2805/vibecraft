package com.java.vibecraft.llm.tools;
...
public class CodeGenerationTools {
    ...
    public CodeGenerationTools(ProjectFileService projectFileService, Long projectId) {
        this(projectFileService, projectId, () -> { });
    }

    public CodeGenerationTools(ProjectFileService projectFileService, Long projectId, Runnable onRead) {
