...
public class Plan {
    ...
    /**
     * Kept on the entity and the API, but <b>enforced nowhere</b> (2026-09-16, a deliberate product call):
     * {@code maxTokensPerDay} is the real limit on every plan, so nothing claims unlimited AI in the UI. It
     * stays so a plan can be flipped to genuinely uncapped later without a migration.
     */
    Boolean unlimitedAi;
