...
public interface UsageService {
     ...
     */
    void recordTokenUsage(com.java.vibecraft.dto.usage.UsageRecord record);
     ...
     *
     * @throws com.java.vibecraft.error.QuotaExceededException mapped to 402 by the global handler
     */
